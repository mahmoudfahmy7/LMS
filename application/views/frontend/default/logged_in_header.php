            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#">
                        <img src="<?php echo base_url().'uploads/system/logo-dark.png'; ?>" alt="" style="height:35px">
                    </a>
                    ...
                    <form class="inline-form" action="<?php echo site_url('home/search'); ?>" method="get" style="width: 50%;">
                        <div class="input-group search-box mobile-search">
                            <input type="text" name = 'query' class="form-control" placeholder="<?php echo get_phrase('search_for_courses'); ?>"  style="border: 1px solid #A1A7B3;">
                            <div class="input-group-append" style="border: 1px solid #A1A7B3;border-left: 0px solid #A1A7B3;">
                    ...
                    <?php }
                        ...
                        <div class="instructor-box menu-icon-box">
                            <div class="icon">
                                <a onclick="jQuery('#modal-5').modal('show', {backdrop: 'static'});" 
                                style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;">
                                    <?php echo get_phrase('Uprade_to_instructor'); ?>
