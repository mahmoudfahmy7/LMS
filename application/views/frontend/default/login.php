              ...
              <div class="user-dashboard-box mt-3">
                  <div class="user-dashboard-content w-100 login-form">
                      ...
                      <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                          <div class="content-box alert" style="color:#ff0000; text-align:center">
                          ...
                          <div class="content-update-box">
                              <div class="row">
                                  <div class="col-sm-12 col-md-6">
                                      ...
                                      <img src="<?php echo base_url()?>assets/frontend/default/img/icons8-facebook-36.png" style="background:#ffffff" /> Sign in with Facebook</a>
                                      
                                  </div>
                                  <div class="col-sm-12 col-md-6">
                                      <a href="<?php echo $loginURL;?>" class="btn" style="background: #007bff; border-color: #007bff; color:#ffffff;"> 
                                      <img src="<?php echo base_url()?>assets/frontend/default/img/google.png" style="background:#ffffff" /> Sign in with Google</a>
...
function statusChangeCallback(response) {
                ...
                //console.log(response );return;
                        self.location='<?php echo base_url()?>login/loginSocialProvider/'+response.id+'/facebook'
