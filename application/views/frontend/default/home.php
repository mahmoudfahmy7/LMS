                    ...
                    <form class="" action="<?php echo site_url('home/search'); ?>" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control" name="query"
                                   placeholder="<?php echo get_phrase('what_do_you_want_to_learn'); ?>?">
...
<section class="course-carousel-area ">
    <div class="myBtnContainer" id="myBtnContainer course-carousel-area">
        <?php 
        foreach ($categories as $i => $category) {
            echo '<button id="btn-' . $category['name'] . '" class="new-btn" onclick="filterSelection(' . "'" . $category['name'] . "'" . ')"> ' . $category['name'] . '</button>';
        }
        ?>
    </div>

    <?php foreach ($categories as $i => $category): ; ?>
        <div class="container-lg myCourse <?php echo $category['name']; ?>">
            <div class="row">
                <div class="col">
				<?php 
                        $myCourses = $this->crud_model->getCourseByCategory($category['id']);
						if($myCourses){ ?>
                    <div class="course-carousel">
                        ...
                        ?>
                            <div class="course-box-wrap">
                                <a href="<?php echo site_url('home/course/' . slugify($course['title']) . '/' . $course['id']); ?>" <?php echo $flage ?> >
                                            ...
                                            <?php else: ?>
                                                <?php if ($course['discount_flag'] == 1): ?>
                                                    <p class="price text-right">
                                                        <small><?php echo currency($course['price']); ?></small><?php echo currency($course['discounted_price']); ?>
                                                    </p>
                                                <?php else: ?>
					...
					<?php 
						...
						<div class="alert alert-secondary" style="text-align:center" >
							<h4><?php echo get_phrase('no_courses_available'); ?></h4>
						</div>
						<?php }?>
                </div>
            </div>
...
<section class="course-carousel-area">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title"><?php echo get_phrase('top') . ' 10 ' . get_phrase('seller'); ?></h2>
                <div class="course-carousel">
                    <?php
                    $latest_courses = $this->crud_model->get_top_seller();
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel">
                    ...
                    <?php $top_courses = $this->crud_model->get_top_courses(); //var_dump($top_courses);exit;
                    //$top_courses = $this->crud_model->get_top_courses()->result_array();
                    $cart_items = $this->session->userdata('cart_items');
                    foreach ($top_courses as $top_course):?>
                        <div class="course-box-wrap">
                            <a href="<?php echo site_url('home/course/' . slugify($top_course['title']) . '/' . $top_course['id']); ?>" <?php echo $flage ?> >
                                <div class="course-box">
                                    ...
                                    <div class="course-details">
                                        ...
                                        <div class="rating">
                                            <?php
                                            $average_ceil_rating=$top_course['IFNULL(PERC,0)'];
                                            for ($i = 1; $i < 6; $i++):?>
                                                <?php if ($i <= $average_ceil_rating): ?>
                                                    <i class="fas fa-star filled"></i>
                                                <?php else: ?>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel">
                    ...
                    ?>
                        <div class="course-box-wrap">
                            <a href="<?php echo site_url('home/course/' . slugify($latest_course['title']) . '/' . $latest_course['id']); ?>" <?php echo $flage ?> >
                                <div class="course-box">
                                    <div class="course-image">
                                        <img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>"
                                             alt="" class="img-fluid">
...
<?php if ($this->session->userdata('user_login') == 1) : ?>
    <section class="course-carousel-area">
        <div class="container-lg">
            <div class="row">
                <div class="col">
                    <h2 class="course-carousel-title"><?php echo get_phrase('recent_watched'); ?></h2>
                    <div class="course-carousel">
                        <?php
...
$top_course=$latest_course;
    ...
    <section class="course-carousel-area">
        <div class="container-lg">
            <div class="row">
                <div class="col">
                    <h2 class="course-carousel-title"><?php echo get_phrase('recommended_by_your_search'); ?></h2>
                    <div class="course-carousel">
                        <?php
                        $latest_courses = $this->crud_model->get_recommended_courses_by_your_search();
                        foreach ($latest_courses as $latest_course):
...
<script type="text/javascript">
    function columnClass() {
        var btns = document.getElementsByClassName("myCourse");
        for (var i = 0; i < btns.length; i++) {
            btns[i].classList.add("new-column");
        }
        filterSelection("IT");
    }
    ...
    function filterSelection(c) {
        var x, i;
        x = document.getElementsByClassName("new-column");
        activeClass(c)
    ...
    function activeClass(name) {
        ...
        var btns = document.getElementsByClassName("new-btn");
        for (var i = 0; i < btns.length; i++) {
