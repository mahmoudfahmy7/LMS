        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('user/coupons/add'); ?>" method="post"
                        ...
                        <div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<input type="number" class="form-control url" id="percent" name="percent" value="0" required onchange="changeOption()" >
								</div>
								<div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="code"><?php echo get_phrase('expired_count'); ?><span
                                        class="required">*</span></label></label>
                            <input type="number" class="form-control url" id="expired_count" name="expired_count" required>
                        </div>
