...
<form action="<?php echo site_url('user/quizes/'.$param3.'/edit/'.$param2); ?>" method="post">
	...
	<div class="form-group">
		<div class="custom-control custom-checkbox">
			<input type="checkbox" class="custom-control-input" name="preview" id="preview" <?php if($quiz_details['preview'] == 1) echo 'checked'; ?> >
			<label class="custom-control-label" for="preview"><?php echo get_phrase('check_if_this_is_a_preview_quiz'); ?></label>
		</div>
	</div>
