        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"><i
                    ...
                    <a href="<?php echo site_url('user/coupon_form/add_coupon'); ?>"
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php //echo site_url('user/coupons/filter_by_date_range') ?><!--"-->
                <!--                              method="get">-->
                <!--                            <div class="col-xl-10">-->
							...
							if($coupon['i_factor']==1)$isPercent='%';
                                ...
                                <tr class="gradeU">
                                    ...
                                    <td>
                                        ...
                                        <small><?php echo get_phrase('created_by') . ': ' . $user_data['first_name'] . ' ' . $user_data['last_name']; ?></small>
                                    </td>
                                    ...
                                    <td>
                                        <!--a href="<?php// echo site_url('user/coupon_form/show_coupon/' . $coupon['id']); ?>"
                                        ...
                                        <a href="<?php echo site_url('user/coupon_form/edit_coupon/' . $coupon['id']); ?>" title="Edit Coupon"
                                           class="btn btn-icon btn-outline-info btn-sm"> <i class="mdi mdi-wrench"></i></a>
										   
										<a href="#" onclick="confirm_modal('<?php echo site_url('user/coupons/delete/' . $coupon['id']); ?>')" title="Delete Coupon"
                                           class="btn btn-icon btn-outline-danger btn-sm"> <i class="dripicons-trash"></i></a>

                                        <!--a href="<?php //echo site_url('user/coupons/delete/' . $coupon['id']); ?>"
                                           class="btn btn-icon btn-outline-danger btn-sm"> <i class="dripicons-trash"></i></a-->
                                    </td>
                                </tr>
                            <?php endforeach; ?>
