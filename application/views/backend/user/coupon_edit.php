        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('user/coupons/edit/'.$coupon['id']); ?>" method="post"
                        ...
                        <div class="form-group" id="discounntDiv">
							...
							?>
							    ...
							    <label style="color:blue" id="note" ><?php echo get_phrase('This_coupon_will_deduct'); ?> <span  id="percent_1"><?php echo $coupon['percent'];?></span> <?php if($coupon['i_factor']==1){echo '% ';}else if($coupon['i_factor']==2){echo 'USD ';}; echo get_phrase('from_course_total_price'); echo "<br>"; ?></label>
							...
							<span id="comm1" style="color:green;"><?php echo "<br>";?>Course price before discount : </span><span style="color:green;" id="id_price"><?php echo $priceOfCourse;?></span>
							<span id="comm2" style="color:red;"><?php echo "<br>";?>Course price after discount : </span><span style="color:red;" id="id_price_after"><?php echo $priceAfterDissount;?></span>
...
<script type="text/javascript">
    ...
    function checkCourses(id) {
        ...
        if (id > 0) {
            ...
            const url = "http://" + "<?php echo $url; ?>" + "/udmy/home/course/";
