    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('student_view_form'); ?></h4>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <label class="col-md-9 col-form-label"><?php echo $user_data['first_name']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="last_name"><?php echo get_phrase('last_name'); ?> <span class="required">*</span> </label>
                                            <label class="col-md-9 col-form-label"><?php echo $user_data['last_name']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="linkedin_link"><?php echo get_phrase('biography'); ?></label>
                                            <label class="col-md-9 col-form-label"><?php echo $user_data['biography']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <label class="col-md-9 col-form-label"><?php echo $user_data['email']; ?></label>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <label class="col-md-9 col-form-label"><?php echo $social_links['facebook']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="twitter_link"><?php echo get_phrase('twitter'); ?></label>
                                            <label class="col-md-9 col-form-label"><?php echo $social_links['twitter']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="linkedin_link"><?php echo get_phrase('linkedin'); ?></label>
                                            <label class="col-md-9 col-form-label"><?php echo $social_links['linkedin']; ?></label>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <label class="col-md-9 col-form-label"><?php echo $paypal_keys[0]['production_client_id']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="stripe_public_key"><?php echo get_phrase('stripe_public_key'); ?></label>
                                            <label class="col-md-9 col-form-label"><?php echo $stripe_keys[0]['public_live_key']; ?></label>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="stripe_secret_key"><?php echo get_phrase('stripe_secret_key'); ?></label>
                                            <label class="col-md-9 col-form-label"><?php echo $stripe_keys[0]['secret_live_key']; ?></label>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                            </div>
