                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/user_form/view_user_form/'.$user['id']) ?>"><?php echo get_phrase('view'); ?></a></li>
										...
										<li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/users/ban/'.$user['id']); ?>');"><?php echo get_phrase('ban'); ?></a></li>
                                        <?php } elseif($user['status']==0){?>
										<li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/users/unban/'.$user['id']); ?>');"><?php echo get_phrase('unban'); ?></a></li>
										<?php } ?>
									</ul>
                                </div>
                              </td>
