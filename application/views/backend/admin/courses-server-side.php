...
foreach($courses as $course){
    ...
    if($course['is_free_course'] == 1)
        ...
        $paid++;
}   //$course['status'] == 'active'$course['is_free_course'] == 1)
?>
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $active//$status_wise_courses['active']->num_rows(); ?></span></h3>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $pending//$status_wise_courses['pending']->num_rows(); ?></span></h3>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $free//$this->crud_model->get_free_and_paid_courses('free')->num_rows(); ?></span></h3>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $paid//$this->crud_model->get_free_and_paid_courses('paid')->num_rows(); ?></span></h3>
        ...
        <div class="card">
            ...
            <div class="table-responsive-sm mt-4" style="overflow-x:auto;">
                <?php if (count($courses) > 0): ?>
                    <table id="course-datatable-server-side" class="table table-striped table-centered mb-0" width="100%" data-page-length='25'>
                        <thead>
                            <tr>
                                <th>#</th>
