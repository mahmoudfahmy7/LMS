...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('view').': '.$course_details['title']; ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
											...
											<div class="form-group row mb-3">
												...
												<div class="col-md-10">
													<input readonly type="text" class="form-control not-allowed bootstrap-tag-input" id = "meta_keywords" name="meta_keywords"  style="width: 100%;" value="<?php echo $course_details['meta_keywords']; ?>"/>
												</div>
											</div>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <input readonly type="text" class="form-control not-allowed" id="course_title" name = "title" placeholder="<?php echo get_phrase('enter_course_title'); ?>" value="<?php echo $course_details['title']; ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="short_description"><?php echo get_phrase('short_description'); ?></label>
                                                <div class="col-md-10">
                                                    <textarea readonly name="short_description" id = "short_description" class="form-control not-allowed"><?php echo $course_details['short_description']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="description"><?php echo get_phrase('description'); ?></label>
                                                <div class="col-md-10">
                                                    <textarea readonly name="description" id = "description" class="form-control not-allowed"><?php echo $course_details['description']; ?></textarea>
                                                </div>
                                            </div>
											<?php /*$cat_name='';
											foreach ($categories->result_array() as $category):
												...
												foreach ($sub_categories as $sub_category):
													if($sub_category['id'] == $course_details['sub_category_id'])
											...
											<!--div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <input readonly type="text" class="form-control not-allowed" id="sub_category_id" name = "sub_category_id" value="<?php echo $cat_name; ?>" required>
                                                </div>
                                            </div-->
                                            <div class="form-group row mb-3 ">
                                                <label class="col-md-2 col-form-label" for="sub_category_id"><?php echo get_phrase('category'); ?><span class="required">*</span></label>
                                                <div class="col-md-10">
                                                    <select disabled class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <select disabled  class="form-control select2 not-allowed" data-toggle="select2" name="level" id="level">
													...
													<option value="allLevels" <?php if($course_details['level'] == "allLevels") echo 'selected'; ?>><?php echo get_phrase('All_levels'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select disabled readonly class="form-control select2 not-allowed" data-toggle="select2" name="language_made_in" id="language_made_in">
                                            ...
                                            <!--div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10">
                                                    <div class="custom-control custom-checkbox">
                                                        <input disabled type="checkbox" class="custom-control-input not-allowed" name="is_top_course" id="is_top_course" value="1" < ?php if($course_details['is_top_course'] == 1) echo 'checked'; ?>>
                                                ...
                                                <div class="col-md-9">
                                                                ...
                                                                <div class="d-flex mt-2">
                                                                    <div class="flex-grow-1 px-3">
                                                                        <div class="form-group">
                                                                            <input readonly type="text" class="form-control not-allowed" name="requirements[]" id="requirements" placeholder="<?php echo get_phrase('provide_requirements'); ?>" value="<?php echo $requirement; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <!--div class="">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="d-flex mt-2">
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <input readonly type="text" class="form-control not-allowed" name="requirements[]" id="requirements" placeholder="<?php echo get_phrase('provide_requirements'); ?>">
                                                                </div>
                                                            </div>
                                                            <!--div class="">
                                                                <button type="button" class="btn btn-success btn-sm" style="" name="button" onclick="appendRequirement()"> <i class="fa fa-plus"></i> </button>
                                            ...
                                            <div class="col-md-9">
                                                    ...
                                                    <?php if (count(json_decode($course_details['outcomes'])) > 0): ?>
                                                        ...
                                                        <?php if ($counter == 0):
                                                            ...
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input readonly type="text" class="form-control not-allowed" name="outcomes[]" placeholder="<?php echo get_phrase('provide_outcomes'); ?>" value="<?php echo $outcome; ?>">
                                                                    </div>
                                                                </div>
                                                                <!--div class="">
                                                ...
                                                <?php else: ?>
                                                    <div class="d-flex mt-2">
                                                        <div class="flex-grow-1 px-3">
                                                            <div class="form-group">
                                                                <input readonly type="text" class="form-control not-allowed" name="outcomes[]" placeholder="<?php echo get_phrase('provide_outcomes'); ?>">
                                                            </div>
                                                        </div>
                                                        <!--div class="">
                                                            <button type="button" class="btn btn-success btn-sm" name="button" onclick="appendOutcome()"> <i class="fa fa-plus"></i> </button>
                                                ...
                                                <div id = "blank_outcome_field">
                                                    <div class="d-flex mt-2">
                                                        <div class="flex-grow-1 px-3">
                                                            <div class="form-group">
                                                                <input readonly type="text" class="form-control not-allowed" name="outcomes[]" id="outcomes" placeholder="<?php echo get_phrase('provide_outcomes'); ?>">
                                                            </div>
                                                        </div>
                                                        <!--div class="">
                                                            <button type="button" class="btn btn-danger btn-sm" style="margin-top: 0px;" name="button" onclick="removeOutcome(this)"> <i class="fa fa-minus"></i> </button>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        <div class="offset-md-2 col-md-10">
                                            <div class="custom-control custom-checkbox">
                                                <input disabled type="checkbox" class="custom-control-input" name="is_free_course" id="is_free_course" value="1" <?php if($course_details['is_free_course'] == 1) echo 'checked'; ?>  onclick="togglePriceFields(this.id)">
                                    ...
                                    <div class="paid-course-stuffs">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input disabled type="number" class="form-control not-allowed" id="price" name = "price" min="0" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" value="<?php echo $course_details['price']; ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="offset-md-2 col-md-10">
                                                <div class="custom-control custom-checkbox">
                                                    <input disabled type="checkbox" class="custom-control-input" name="discount_flag" id="discount_flag" value="1" <?php if($course_details['discount_flag'] == 1) echo 'checked'; ?>>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input disabled type="number" class="form-control not-allowed" name="discounted_price" id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" value="<?php echo $course_details['discounted_price']; ?>" min="0">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <select disabled class="form-control select2" data-toggle="select2" name="course_overview_provider" id="course_overview_provider">
                                ...
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10"> 
                                            <input disabled type="text" class="form-control not-allowed" name="course_overview_url" id="course_overview_url" placeholder="E.g: https://www.youtube.com/watch?v=oBtf8Yglw2w" value="<?php echo $course_details['video_url'] ?>">
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input disabled type="text" class="form-control not-allowed bootstrap-tag-input" id = "meta_keywords" name="meta_keywords" data-role="tagsinput" style="width: 100%;" value="<?php //echo $course_details['meta_keywords']; ?>"/>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                                <!--div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <textarea disabled name="meta_description" class="form-control not-allowed"><?php //echo $course_details['meta_description']; ?></textarea>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            <!--/div> <!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-center">
                                        ...
                                        <div class="mb-3 mt-3">
										<?php 
										if($course_details['status'] == 'pending'){ 
										$course_status_changing_message = get_phrase('mark_as_active');
										$course_status_changing_action = "showAjaxModal('" . site_url('modal/popup/mail_on_course_status_changing_modal/active/' . $course_details['id'] . '/' . "all" . '/' . "all" . '/' . "all" . '/' . "all") . "', '" . $course_status_changing_message . "')";?>
                                            <button type="button" class="btn btn-success text-center" onclick="<?php echo $course_status_changing_action; ?>"><?php echo $course_status_changing_message; ?></button>
                                        <?php }elseif($course_details['status'] == 'active'){
											$course_status_changing_message = get_phrase('mark_as_pending');
											$course_status_changing_action = "showAjaxModal('" . site_url('modal/popup/mail_on_course_status_changing_modal/pending/' . $course_details['id'] . '/' . "all" . '/' . "all" . '/' . "all" . '/' . "all") . "', '" . $course_status_changing_message . "')";?>
											<button type="button" class="btn btn-danger text-center" onclick="<?php echo $course_status_changing_action; ?>"><?php echo $course_status_changing_message; ?></button>
										<?php } ?>										</div>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row -->
