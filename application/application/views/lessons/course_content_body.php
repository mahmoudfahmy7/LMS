  ...
  <div class="" style="text-align: center;">
    ...
    if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
      ...
      <?php else :?>
        ...
        <script>
            var newPlayer2 = new SubPlayerJS('#player', '<?php echo base_url().$lesson_details['video_url']?>');
            <?php $srt=json_decode($lesson_details['attachment']);?>
            /*
            <?php 
            $key1='';
            $value1='';
                foreach($srt as $key=>$val){
                    $key1=$key;
                    $value1='uploads/lesson_files/'.$val;
                    break;
                }
                //echo $key1."  ".$value1;
           ?>
            */
	            newPlayer2.setSubtitle('<?php echo base_url().$value1?>'); 
