...
<div class="left-side-menu left-side-menu-detached">
    ...
    <ul class="metismenu side-nav side-nav-light">
        ...
        <li class="side-nav-item <?php if ($page_name == 'coupons' || $page_name == 'coupon_add' || $page_name == 'coupons_edit'): ?> active <?php endif; ?>">
            <a href="javascript: void(0);"
               class="side-nav-link <?php if ($page_name == 'coupons' || $page_name == 'coupon_add' || $page_name == 'coupons_edit'): ?> active <?php endif; ?>">
                <i class="dripicons-box"></i>
                <span> <?php echo get_phrase('coupons'); ?> </span>
                <span class="menu-arrow"></span>
            </a>
            <ul class="side-nav-second-level" aria-expanded="false">
                <li class="<?php if ($page_name == 'coupons' || $page_name == 'coupons_edit') echo 'active'; ?>">
                    <a href="<?php echo site_url('admin/coupons'); ?>"><?php echo get_phrase('coupons'); ?></a>
                </li>

                <li class="<?php if ($page_name == 'coupons_add') echo 'active'; ?>">
                    <a href="<?php echo site_url('admin/coupon_form/add_coupon'); ?>"><?php echo get_phrase('add_new_coupon'); ?></a>
                </li>
            </ul>
        </li>

        <li class="side-nav-item <?php if ($page_name == 'about_us' || $page_name == 'contact'): ?> active <?php endif; ?>">
            <a href="javascript: void(0);"
               class="side-nav-link <?php if ($page_name == 'about_us' || $page_name == 'contact'): ?> active <?php endif; ?>">
                <i class="dripicons-browser"></i>
                <span> Pages </span>
                <span class="menu-arrow"></span>
            </a>
            <ul class="side-nav-second-level" aria-expanded="false">
                <li class="<?php if ($page_name == 'about_us') echo 'active'; ?>" style="display:none">
                    <a href="<?php echo site_url('admin/about_us'); ?>">About</a>
                </li>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/certificate'); ?>"
               class="side-nav-link <?php if ($page_name == 'certificate') echo 'active'; ?>">
                <i class="dripicons-archive"></i>
                <span><?php echo get_phrase('certificate'); ?></span>
            </a>
        </li>
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/widget'); ?>"
               class="side-nav-link <?php if ($page_name == 'widget') echo 'active'; ?>">
                <i class="dripicons-archive"></i>
                <span><?php echo get_phrase('widget'); ?></span>
            </a>
        </li>
        
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/promotional'); ?>" class="side-nav-link <?php if ($page_name == 'promotional_link') echo 'active';?>">
                <i class="dripicons-link"></i>
                <span><?php echo get_phrase('promotional_link'); ?></span>
            </a>
        </li>
        ...
        <li class="side-nav-item">
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
				<li class="<?php if ($page_name == 'conversions') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/conversions'); ?>"><?php echo get_phrase('conversions'); ?></a>
				</li>
                ...
                <?php //if (get_settings('allow_instructor') == 1): ?>
                    <!--<li class="<?php //if ($page_name == 'instructor_revenue') echo 'active'; ?>">
                        <a href="<?php //echo site_url('admin/instructor_revenue'); ?>">
                            <?php //echo get_phrase('instructor_revenue'); ?> <span
                                    class="badge badge-danger-lighten badge-pill"><?php //echo $this->db->get_where('payment', array('instructor_payment_status' => 0))->num_rows() ?></span>
                        </a>
                    </li>-->
                <?php //endif; ?>
            </ul>
        ...
        <li class="side-nav-item  <?php if ($page_name == 'system_settings' || $page_name == 'frontend_settings' || $page_name == 'payment_settings' || $page_name == 'instructor_settings' || $page_name == 'smtp_settings' || $page_name == 'manage_language' || $page_name == 'about' || $page_name == 'themes' || $page_name == 'mobile_app'): ?> active <?php endif; ?>">
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class="<?php if ($page_name == 'contact') echo 'active'; ?>">
                    <a href="<?php echo site_url('admin/contact_us'); ?>"><?php echo get_phrase('contact'); ?></a>
                </li>
                <!--    <li class = "<?php /*if($page_name == 'contact') echo 'active'; */ ?>">
                    <a href="<?php /*echo site_url('admin/unread_contact'); */ ?>"><?php /*echo get_phrase('unread contact'); */ ?></a>
                </li>-->
