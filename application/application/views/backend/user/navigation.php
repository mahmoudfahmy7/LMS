...
<div class="left-side-menu left-side-menu-detached">
	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
            ...
            <li class="side-nav-item">
				<a href="<?php echo site_url('user/promotional'); ?>" class="side-nav-link <?php if ($page_name == 'promotional_link')echo 'active';?>">
            ...
            <li class="side-nav-item <?php if ($page_name == 'coupons' || $page_name == 'coupon_add' || $page_name == 'coupons_edit'): ?> active <?php endif; ?>">
                ...
                <ul class="side-nav-second-level" aria-expanded="false">
                    <li class="<?php if ($page_name == 'coupons' || $page_name == 'coupons_edit') echo 'active'; ?>">
                        <a href="<?php echo site_url('user/coupons'); ?>"><?php echo get_phrase('coupons'); ?></a>
                    </li>

                    <li class="<?php if ($page_name == 'coupons_add') echo 'active'; ?>">
                        <a href="<?php echo site_url('user/coupon_form/add_coupon'); ?>"><?php echo get_phrase('add_new_coupon'); ?></a>
                    </li>
                </ul>
            </li>
			...
			<ul class="side-nav-second-level" aria-expanded="false">
				<li class = "<?php if($page_name == 'payment_settings') echo 'active'; ?>">
					<a href="<?php echo site_url('home/profile/user_payment')//site_url('user/payment_settings'); ?>"><?php echo get_phrase('payment_settings'); ?></a>
				</li>
			</ul>
		</li>
	    </ul>
