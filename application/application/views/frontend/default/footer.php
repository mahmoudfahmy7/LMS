        ...
        <div class="row">
            <div class="col-md-6">
                <p class="copyright-text">
                    <a href=""><img src="<?php echo base_url() . 'uploads/system/logo-dark.png'; ?>" alt=""
            ...
            <div class="col-md-6">
                <ul class="nav justify-content-md-end footer-menu">
                    <li class="nav-item">
                        <a class="nav-link"
                           href="https://blog.lacyna.com/" target="_blank"><?php echo get_phrase('blog'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                           href="<?php echo site_url('home/contact_us'); ?>"><?php echo get_phrase('contact'); ?></a>
                    </li>
                    <li class="nav-item" style="display:none">
                        <a class="nav-link"
                           href="<?php echo site_url('home/about_us'); ?>"><?php echo get_phrase('about'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="<?php echo site_url('home/terms_and_condition'); ?>"><?php echo get_phrase('terms_&_condition'); ?></a>
                    </li>
                    ...
                    <div class="col-md-6" style="display:none">
                        <form action="<?php echo site_url('home/paypal_checkout'); ?>" method="post">
                            <input type="hidden" class="total_price_of_checking_out" name="total_price_of_checking_out"
                                   value="">
                            <button type="submit"
                                    class="btn btn-default paypal" <?php echo $paypal_status; ?>><?php echo get_phrase('paypal'); ?></button>
                        </form>
                    </div>
                    <div class="col-md-12">
                        <form action="<?php echo site_url('home/stripe_checkout'); ?>" method="post">
                            <input type="hidden" class="total_price_of_checking_out" name="total_price_of_checking_out"
                                   value="">
                            <button type="submit"
                                    class="btn btn-primary stripe" <?php echo $stripe_status; ?>><?php echo get_phrase('stripe'); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="couponModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content payment-in-modal">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo get_phrase('coupon_code'); ?>!</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="col-md-12">
                        <form >
                            <div class="form-group">
                                <label for="code"><?php echo get_phrase('coupon_code'); ?></label>
                                <input type="text" class="form-control url" id="coupon_code" name="coupon_code">
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="addCoupon()"  class="btn btn-primary"><?php echo get_phrase('enter_code'); ?></button>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="modal-rating-box">
                                <h4 class="rating-title"><?php echo get_phrase('how_would_you_rate_this_course_overall'); ?>
                                    ?</h4>
                        ...
                        <div class="col-md-6">
                            <div class="modal-rating-comment-box">
                                ...
                                <textarea id="review_of_a_course" name="review_of_a_course"
                                          placeholder="<?php echo get_phrase('describe_your_experience_what_you_got_out_of_the_course_and_other_helpful_highlights') . '. ' . get_phrase('what_did_the_instructor_do_well_and_what_could_use_some_improvement') ?>?"
...
<script type="text/javascript">
    ...
    function addCoupon() {
        ...
        var couseId = $('#course-id').val();
        $.ajax({
            type: 'GET',
            url: '<?php echo site_url('home/add_coupon/'); ?>' + code + '/' + couseId,
            success: function (response) {
                if (response === ''){
