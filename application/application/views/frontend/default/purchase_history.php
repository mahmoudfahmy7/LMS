                            ...
                            <li class="purchase-history-items mb-2">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row hideWeb">
                                            <div class="col-sm-3 date">
                                                <?php echo get_phrase('date'); ?>: <?php echo date('D, d-M-Y', $each_purchase['date_added']); ?>
                                            </div>
                                            <div class="col-sm-3 price"><?php echo get_phrase('total_price'); ?>:<b>
                                                 <?php echo currency($each_purchase['amount']); ?>
                                            </b></div>
                                            <div class="col-sm-4 payment-type">
                                                <?php echo get_phrase('payment_type'); ?>: <?php echo ucfirst($each_purchase['payment_type']); ?>
                                            </div>
                                            <div class="col-sm-2">
