                    ...
                    <div class="course-box-wrap">
                            <div class="course-box">
                                <a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>">
                                    <div class="course-image" style="height: 205px;">
                                ...
                                <div class="" id = "course_info_view_<?php echo $my_course['course_id'];  ?>">
                                  <div class="course-details">
                                      ...
                                      <div class="progress" style="height: 5px;">
                                        <div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: <?php  $course_progress=course_progress($my_course['course_id']); echo $course_progress?>%" aria-valuenow="<?php echo course_progress($my_course['course_id']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                      </div>
                                      ...
                                      <div class="rating your-rating-box" style="position: unset; margin-top: -18px;">
                                          ...
                                          <p class="your-rating-text">
                                            ...
                                            <?php } else{ ?>
                                            <a href="javascript::"  style="color: #2a303b"> &nbsp;</a>
                                            <?php }?>
                                  ...
                                  <div class="row" style="padding: 5px;">
                                      <div class="col-md-12">
                                          ...
                                          if ($course_progress==100){ 
                                                $q=$this->db->query("select * from user_certificate where fk_i_user_id='".$this->session->userdata('user_id')."' and fk_i_crs_id='".$my_course['course_id']."'");
                                                //echo $this->db->last_query();
                                                $certRes=$q->result();
                                                if(sizeof($certRes)>0){
                                          ?>
                                          <a href="<?php echo site_url('home/certificate/'.$certRes[0]->serial_no); ?>" class="btn" style="width: 100%;"><?php echo get_phrase('course_cert'); ?></a>
                                          <?php }
                                          }?>
                                      </div>
                                  </div>
